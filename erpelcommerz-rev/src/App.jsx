...
function App() {
  ...
  return (
    <>
{/* Navbar */}
<nav className="fixed top-0 left-0 w-full bg-purple-700 text-white shadow-md" aria-label="Main Navigation">
  <div className="container mx-auto px-4 py-3 flex justify-between items-center">
    <div className="text-lg font-bold">XI RPL 2</div>
    <ul className="flex space-x-6">
      <li>
        <a href="#home" className="hover:text-gray-300" aria-label="Go to Home Section">
          Beranda
        </a>
      </li>
      <li>
        <a href="#galeri" className="hover:text-gray-300" aria-label="Go to Gallery Section">
          Galeri
        </a>
      </li>
      <li>
        <a href="#catalog" className="hover:text-gray-300" aria-label="Go to Catalog Section">
          Katalog
        </a>
      </li>
    </ul>
...
<section
  id="home"
  className="h-screen bg-gradient-to-b from-purple-500 to-purple-700 flex items-center justify-center text-center text-white relative overflow-hidden mb-16"
>
  {/* Background */}
  <div
    className="absolute top-0 left-0 w-full h-full bg-cover bg-center"
    style={{ backgroundImage: "url('/images/heroimages.jpg')" }}
    aria-hidden="true"
  ></div>
  <div className="absolute top-0 left-0 w-full h-full bg-black opacity-20"></div>

  <div className="relative z-10 space-y-4">
    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-wider animate__animated animate__fadeIn animate__delay-1s">
      Selamat Datang
    </h1>
    <h2 className="text-2xl md:text-3xl font-bold tracking-wider animate__animated animate__fadeIn animate__delay-1s">
      R.P.L E-commerce
    </h2>
    <button className="px-6 py-3 bg-white text-purple-700 font-bold rounded-full hover:bg-gray-200 transition transform hover:scale-105 animate__animated animate__fadeIn animate__delay-2s" aria-label="Continue to shopping">
      Lanjutkan
    </button>
  </div>
</section>
...
<section
  id="catalog"
  className="py-16 bg-gradient-to-b from-purple-700 to-purple-900 text-white"
>
  <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {products[activeTab].map((product) => (
        <div
          key={product.id}
          className="bg-white text-black rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition"
          role="listitem"
        ...
        >
          <img
            ...
            onError={(e) => e.target.src = '/images/default.jpg'} // Fallback image on error
            loading="lazy"
          />
          <div className="p-6">
      ...
      <div className="space-y-4">
        <details
          className="group border-s-4 border-purple-700 bg-gray-50 p-6 dark:bg-gray-900 [&_summary::-webkit-details-marker]:hidden"
          open
        >
          ...
          <p className="mt-4 leading-relaxed text-gray-700 dark:text-gray-200">
            Untuk transaksi bisa menggunakan online layaknya ecommerce lain dan
            juga bisa jasa antar apabila jarak dan jangkauan memadai
          </p>
        </details>

        <details className="group border-s-4 border-purple-700 bg-gray-50 p-6 dark:bg-gray-900 [&_summary::-webkit-details-marker]:hidden">
          <summary className="flex cursor-pointer items-center justify-between gap-1.5">
            <h2 className="text-lg font-medium text-gray-900 dark:text-white">
              Metode Pembayaran
            </h2>
          ...
          <p className="mt-4 leading-relaxed text-gray-700 dark:text-gray-200">
            Untuk Pembayarannya bisa menggunakan{" "}
            <b>QRIS, GOPAY, DANA, OVO DAN E-WALLET </b> lainnya. Tersedia juga
            untuk pembayaran <b>TUNAI / COD </b> dan <b>Kartu Kredit</b>
          </p>
        </details>
      </div>
      ...
      <section className="bg-gray-50">
        <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="md:flex md:items-end md:justify-between">
            ...
            <a
              href="#"
              className="mt-6 inline-flex shrink-0 items-center gap-2 rounded-full border border-purple-600 px-5 py-3 text-purple-600 transition hover:bg-purple-600 hover:text-white md:mt-0"
            >
          ...
          <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <div>
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-4 leading-relaxed text-gray-700">
                    ...
                    Mollitia non magnam pariatur. Ipsa quis minima omnis,
                    tempora, iure praesentium nostrum ab porro doloribus modi
                    quaerat repellat cupiditate similique commodi unde.
                  </p>
                </div>
              </div>
            ...
            <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
              <div>
                ...
                <div className="mt-4">
                  <p className="text-2xl font-bold text-purple-600 sm:text-3xl">
                    Murah & Bersahaja Di Kantong
                  </p>

                  <p className="mt-4 leading-relaxed text-gray-700">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Perspiciatis doloribus maxime adipisci repellendus itaque
                    nesciunt sint officiis et minima voluptate. Eligendi quaerat
                    impedit iste hic quibusdam culpa officiis suscipit itaque?
                  </p>
                </div>
              </div>
            ...
            <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
              <div>
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-4 leading-relaxed text-gray-700">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Praesentium nemo voluptatem fugiat, optio tempore ipsum
                    natus, iste doloribus fugit quos deleniti, repellendus odio
                    unde dolor! Reprehenderit quidem repudiandae velit aperiam.
                  </p>
                </div>
              </div>

              <footer className="mt-4 text-sm font-medium text-gray-700 sm:mt-6">
                &mdash; Fadil Bayangan
              </footer>
            </blockquote>
          </div>
        </div>
      ...
      <footer className="bg-gray-50 dark:bg-gray-900">
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="flex justify-center text-purple-600 sm:justify-start dark:text-purple-300">
              {/* <svg className="h-8" viewBox="0 0 118 24" fill="none" xmlns=""> */}
                {/* <path
            ...
            <p className="mt-4 text-center text-sm text-gray-500 lg:mt-0 lg:text-right dark:text-gray-400">
              ...
              <a href="http://github.com/Witthayanuraks">rhazxl</a>
            </p>
          </div>
        </div>
      </footer>
